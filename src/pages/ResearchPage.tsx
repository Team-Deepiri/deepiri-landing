...
import ResearchRepoCard from '../components/ResearchRepoCard';
import { researchAreas } from '../data/researchData';
import { researchRepos } from '../data/researchRepos';
      ...
      <main className="research-page">
        <div className="container">
          ...
          <section className="research-section">
            ...
            <div className="methodology-grid">
              {researchRepos.map((repo) => (
                <ResearchRepoCard key={repo.iconKey} repo={repo} />
              ))}
            </div>
          </section>
        </div>
